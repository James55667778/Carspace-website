      ...
      <td>
        ...
        <div style="width:680px;padding:0 10px;margin:0 auto;">
          <div style="line-height:1.5;font-size:14px;margin-bottom:25px;color:#4d4d4d;">
            <strong style="display:block;margin-bottom:15px;">Dear {},</strong>{}<strong style="display:block;margin-bottom:15px;">Regards<br>Where2Park Team</strong>
          </div>
        </div>
...
<strong style="display:block;margin-bottom:15px;margin-left: 2em;">
  ...
  &emsp;&emsp;Price per day: {};<br>
  &emsp;&emsp;Price per week: {};<br>
  &emsp;&emsp;Price per month: {};<br>
  &emsp;&emsp;Car space type: {};<br>
  &emsp;&emsp;Max allowed vehicle: {};<br>
  &emsp;&emsp;Amenities: {}<br>
</strong>
<strong style="display:block;margin-bottom:15px;margin-left: 2em;">
