...
export default function CarSpaceDetail() {
  ...
  }, [carSpace, endDate, startDate, user?.first_timer]);
    ...
    if (!token) {
      ...
      if (carSpace) {
        if (startDate && endDate) {
          ...
          reportMessage("Please provide start date and end date", "warning");
        }
      }
    }
  };
                ...
                <Grid item xs={12}>
                  {carSpace && (
                    <CustomerDatePicker
                      ...
                      datesFromOtherBookings={getDatesFromOtherBookings(
